...
)
{
    ...
    TIFF *tif; int m; const char* cp;
    static const char module[] = "TIFFClientOpen";

    /* The following are configuration checks. They should be redundant, 
     * but should not compile to any actual code in an optimised release 
     * build anyway. If any of them fail, (makefile-based or other) 
     ...
     * memory-mapped files and strip chopping when a file is opened 
     * read-only.
     */
